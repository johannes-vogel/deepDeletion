		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ManageShippers-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ManageShippers-display": {
								"semanticObject": "ManageShippers",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=web.manage-Shippers",
									"url": sap.ui.require.toUrl("web/manage-Shippers")
								}
							}
						}
					}
